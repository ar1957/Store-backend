  ...
  try {
    ...
    const result = await pgConnection.raw(`
      SELECT id, tenant_domain, product_id, product_title, variant_id,
             ...
             rxvortex_preset_catalog_id, rxvortex_instructions, order_split_count, created_at
  ...
  try {
    ...
    await pgConnection.raw(`
      INSERT INTO product_treatment_map
        (id, tenant_domain, product_id, product_title, treatment_id, treatment_name, requires_eligibility, rxvortex_preset_catalog_id, rxvortex_instructions, order_split_count, created_at, updated_at)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())
    `, [
      id,
      tenantDomain,
