...
const steps = [
  ...
  {
    name: "Migration15 - order_item_pharmacy_cost table",
    sql: `
      ...
      CREATE INDEX IF NOT EXISTS idx_order_item_pharmacy_cost_order ON order_item_pharmacy_cost (order_id);
    `,
  },
  {
  ...
  {
    name: "Migration20240101000025 - clinic_pharmacy + clinic_staff_pharmacy + pharmacy scoping columns",
    sql: `
      ...
      CREATE INDEX IF NOT EXISTS "idx_clinic_pharmacy_clinic" ON "clinic_pharmacy" ("clinic_id");
      ...
      CREATE INDEX IF NOT EXISTS "idx_clinic_staff_pharmacy_staff" ON "clinic_staff_pharmacy" ("clinic_staff_id");
      CREATE INDEX IF NOT EXISTS "idx_clinic_staff_pharmacy_pharmacy" ON "clinic_staff_pharmacy" ("clinic_pharmacy_id");

      ALTER TABLE "product_treatment_map" ADD COLUMN IF NOT EXISTS "clinic_pharmacy_id" VARCHAR(255);
      ALTER TABLE "pharmacy_sub_order" ADD COLUMN IF NOT EXISTS "clinic_pharmacy_id" VARCHAR(255);
      ALTER TABLE "order_workflow" ADD COLUMN IF NOT EXISTS "clinic_pharmacy_id" VARCHAR(255);
